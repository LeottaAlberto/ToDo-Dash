...
<template>
  ...
  >
    <div
      v-if="props.show"
      class="flex justify-center items-center top-0 left-0 p-0 m-0 z-50 absolute w-full h-full bg-black/20 trnasition"
    ...
    >
      ...
      >
        ...
        <div class="flex flex-col justify-between w-full bg-neutral-600 relative">
          <div
            v-if="props.editable"
            class="flex flex-row justify-end gap-1 text-3xl absolute right-2 top-2"
          >
            <ButtonComponent
              :background="true"
              tool-tip="Edit"
